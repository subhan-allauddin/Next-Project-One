...
interface Course {
  id: number;
  title: string; // Corrected 'tittle' to 'title'
  slug: string;
  description: string;
  price: number;
  instructor: string;
...
function FeaturedCourses() { // Corrected the function name to match convention
              ...
              <BackgroundGradient className="flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-sm">
                <div className="p-4 sm:p-6 flex flex-col items-center text-center  flex-grow">
                  <p className="text-lg sm:text-xl text-black mt-4 mb-2 dark:text-neutral-200">
                    {course.title} {/* Corrected from 'tittle' to 'title' */}
                  </p>
...
export default FeaturedCourses; // Updated to reflect corrected function name
