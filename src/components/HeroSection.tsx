    ...
    <>
      ...
      >
        ...
        <div className="p-4 relative z-10 w-full text-center top-14">
          <h1 className="mt-20 md:mt-0 text-8xl md:tetx-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 ">
          ...
          <div className="mt-4">
            <Button href={"/couses"}>Explore Courses</Button>
          </div>
        </div>
      </div>
